...
import com.game.fragments.IOnlineOpenedGroupAction;
 ...
 */
public class OnlineOpenedGroupActivity extends FragmentActivity implements View.OnClickListener, ChatActionNotification {
    ...
    private IOnlineOpenedGroupAction openedGroupAction;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int groupId = getIntent().getIntExtra(OnlineGroupsFragment.NUMBER_OF_GROUP, 0);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (protoType) {
                    case CUPDATEAOBOUTACTIVITYPLAYER:
                        openedGroupAction.updateAboutActivityPlayerp(msg);
                        break;
                    case CWANTTOPLAY:
    ...
    private void initFragment() {
        ...
        openedGroupAction = (IOnlineOpenedGroupAction) openedGroupFragment;
...
//                fragmentTransaction.attach(openedGroupFragment);
                break;
            case CHAT:
                fragmentTransaction.hide(openedGroupFragment);
                fragmentTransaction.show(chatFragment);
//                fragmentTransaction.detach(openedGroupFragment);
