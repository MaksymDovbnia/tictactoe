...
import com.game.fragments.IOnlineOpenedRoomAction;
import com.game.fragments.OnlineOpenedRoomFragment;
import com.game.onlinegroups.OnlineGroupsFragment;
 ...
 */
public class OnlineOpenedRoomActivity extends FragmentActivity implements View.OnClickListener, ChatActionNotification {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        openGroup.setText(getString(R.string.opened_room) + " " + groupId);
        setGroupFragment();
        initFragment();
        initHandler();
