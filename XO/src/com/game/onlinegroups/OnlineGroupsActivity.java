...
public class OnlineGroupsActivity extends FragmentActivity implements IOnlineGroupsAction {
    ...
    private OnlineGrpoupsFragmentAction onlineGrpoupsFragmentAction;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onlineGrpoupsFragmentAction = (OnlineGrpoupsFragmentAction) onlineGroupsFragment;
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (protoType) {
                    case CGETGROUPLIST:
                        onlineGrpoupsFragmentAction.getGroupList(msg.obj);
                        break;
                    case CTOP100:
